...
import PertanianHeader from "@/components/penyaluran/zakat/pertanian/PertanianHeader";
import PertanianInfo from "@/components/penyaluran/zakat/pertanian/PertanianInfo";
          ...
          {activeTab === "simple" ? (
            ...
            <div className="py-10 text-center">
              ...
              <p className="text-gray-500 max-w-sm mx-auto">
                Kalkulator zakat pertanian lengkap dengan perhitungan biaya
                produksi akan segera tersedia.
              </p>
            </div>
          )}
        </div>
