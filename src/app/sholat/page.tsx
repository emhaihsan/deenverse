...
export const metadata: Metadata = {
  ...
  description: 'Panduan lengkap macam-macam shalat dalam Islam, dari shalat fardhu hingga shalat sunnah. Pelajari niat, tata cara, dan keutamaannya.',
};
...
export default function SholatPage() {
  ...
  const categoryOrder = ['Wajib', 'Sunnah Muakkad', 'Sunnah Ghairu Muakkad', 'Khusus'];
            ...
            groupedShalats[category] && (
              <div key={category}>
                ...
                <p className="text-gray-600 mb-6">
                  {category === 'Wajib' && 'Shalat wajib yang harus dilaksanakan oleh setiap Muslim yang telah memenuhi syarat.'}
                  {category === 'Sunnah Muakkad' && 'Shalat sunnah yang sangat dianjurkan dan hampir wajib.'}
                  {category === 'Sunnah Ghairu Muakkad' && 'Shalat sunnah yang dianjurkan namun tidak seberat sunnah muakkad.'}
                  {category === 'Khusus' && 'Shalat khusus yang dilakukan dalam kondisi atau situasi tertentu.'}
                </p>
